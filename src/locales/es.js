...
export default {
  ...
  animals: {
    ...
    rabbit: ['Conejo', 'm'], cat: ['Gato', 'm'], frog: ['Rana', 'f'],
    bee: ['Abeja', 'f'], dolphin: ['Delfín', 'm'], horse: ['Caballo', 'm'],
    camel: ['Camello', 'm'], zebra: ['Cebra', 'f'], giraffe: ['Jirafa', 'f'],
    ...
    turtle: ['Tortuga', 'f'], unicorn: ['Unicornio', 'm'],
  },
