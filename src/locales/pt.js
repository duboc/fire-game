...
export default {
  ...
  animals: {
    ...
    rabbit: ['Coelho', 'm'], cat: ['Gato', 'm'], frog: ['Sapo', 'm'],
    bee: ['Abelha', 'f'], dolphin: ['Golfinho', 'm'], horse: ['Cavalo', 'm'],
    camel: ['Camelo', 'm'], zebra: ['Zebra', 'f'], giraffe: ['Girafa', 'f'],
    ...
    turtle: ['Tartaruga', 'f'], unicorn: ['Unicórnio', 'm'],
  },
