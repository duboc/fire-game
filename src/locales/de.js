...
export default {
  ...
  animals: {
    ...
    dragon: ['Drache', 'm'], monkey: ['Affe', 'm'], rhino: ['Nashorn', 'n'],
    bull: ['Stier', 'm'], rabbit: ['Hase', 'm'], cat: ['Katze', 'f'],
    frog: ['Frosch', 'm'], bee: ['Biene', 'f'], dolphin: ['Delfin', 'm'],
    horse: ['Pferd', 'n'], elephant: ['Elefant', 'm'], camel: ['Kamel', 'n'],
    zebra: ['Zebra', 'n'], giraffe: ['Giraffe', 'f'], gorilla: ['Gorilla', 'm'],
    ...
    turtle: ['Schildkröte', 'f'], whale: ['Wal', 'm'], unicorn: ['Einhorn', 'n'],
  },
